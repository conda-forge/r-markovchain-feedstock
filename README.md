...
<table><tr>
    ...
    <td>
      <a href="https://github.com/conda-forge/r-markovchain-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/r-markovchain-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
...
pixi add r-markovchain
# for installing globally
pixi global install r-markovchain
```
...
It is possible to list all of the versions of `r-markovchain` available on your platform:
...
```
pixi search r-markovchain --channel conda-forge
```
